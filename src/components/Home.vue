...
.en {
  ...
  height: 100px;
  border-radius: 50%;
  background-image: url("../assets/n_icon_info.png");
...
.content1 {
  ...
  text-align: start;
  margin-bottom: 1%; 
  background: rgba(222, 244, 247, 0.664);
  padding: 1%;
  margin: 1%;
}
.content2 {
...
.home_content-check:checked ~ .home_content-label{
    position: static;
...
.home_content-check:checked ~ .home_content-content::before {
    display: none;
}
  .programing_message {
		position: absolute;
